...
import {
  Trophy, Zap, Flame, Star, LogOut, ChevronRight,
        ...
        <View style={styles.section}>
          <View style={styles.statsGrid}>
            {[
              ...
              { icon: <Flame size={18} color={colors.warning} />, label: 'Streak', value: profile?.current_streak ?? 0 },
      ...
      {tab === 'wallet' && (
        <View style={styles.section}>
          <View style={styles.balanceCard}>
            ...
            <Text style={styles.balanceBig}>${profile?.balance.toFixed(2) ?? '0.00'}</Text>
            <Text style={styles.balanceSub}>Fake Money Balance</Text>
          </View>
